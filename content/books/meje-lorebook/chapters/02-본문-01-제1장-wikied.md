...
여기서 wikilink는 옵시디안 노트 사이를 잇는 `[[표제어]]` 형식의 링크를 가리킵니다. 한 항목에서 다른 항목으로 이동하는 다리이고, 출판본에서는 페이지 번호 참조로, 웹 공개본에서는 클릭 가능한 링크로 변환됩니다. 한 항목 끝에 **관련 항목**이라는 절이 다섯에서 열 개의 wikilink를 모아 두는 식인데, 독자가 한 항목을 다 읽고 책을 덮을지, 다음 항목으로 넘어갈지를 결정하는 지점이 됩니다. wikilink가 잘 짜인 LOREBOOK은 통독 독자가 한 시간을 한 항목에 쓰고 다음 항목으로 자연스럽게 옮겨 가는 흐름을 만들고, 흐름이 끊긴 LOREBOOK은 한 항목에서 독자가 책을 덮게 됩니다.
