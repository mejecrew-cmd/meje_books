...
다만 반대 원칙이 적용되는 영역이 있습니다. LOREBOOK은 단편이 다루지 않은 영역을 자유롭게 채울 수 있다는 점입니다. 단편이 한 인물의 어린 시절을 다루지 않았다면 LOREBOOK이 그 부분을 채워도 됩니다. 단편이 다루지 않은 자료는 LOREBOOK이 단일 진실 공급원이 됩니다. 한 줄로 정리하면 **단편이 다룬 부분은 단편이 우선, 단편이 다루지 않은 부분은 LOREBOOK이 결정**입니다.
