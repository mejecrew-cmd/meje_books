...
한 작품에 등장하는 인물이 30명이라고 해 봅시다. 30명에게 모두 똑같이 8시간을 들이면 240시간이 듭니다. 한 달입니다. 그러나 30명 중 작품의 핵심에 놓이는 인물은 보통 한두 명이고, 다수 사건에 관여하는 인물은 5명에서 15명 사이이며, 한두 장면에만 등장하는 인물이 그 외 나머지입니다. 이 30명에게 모두 같은 시간을 들인다면 핵심 인물에는 시간이 모자라고 단역에는 시간이 과도합니다.

저희는 캐릭터의 위계를 네 단계로 나눕니다. 주인공(작품의 시점·갈등의 축)은 통합 시트 7,000자 ±30%에 8~15시간을 들이고, 주요 인물(다수 사건에 관여)은 4,000자 ±30%에 4~7시간, 조연(일부 사건에 등장)은 2,000자 ±30%에 1~2시간, 단역(단일 장면 또는 이름만)은 1,000자 ±30%에 30분~1시간이 표준입니다. 위계별 인원수는 작품 규모와 장르에 따라 달라지므로 고정하지 않습니다. 단순해 보이지만 작업 시간을 합산하면 차이가 큽니다. 예를 들어 30명을 주인공 1명·주요 인물 4명·조연 10명·단역 15명으로 나누고 각 시간 범위의 하한을 적용하면 총 41시간 30분입니다. 모두에게 8시간씩 쓰는 240시간과 크게 다릅니다. 시간을 줄이는 게 목적이 아니라, 시간을 **비중에 비례하게 두는 것**이 목적입니다.
...
한 작가가 새 작품을 준비하는데, 등장인물 30명을 모두 같은 깊이로 빚기로 결심합니다. 그 마음은 좋습니다. 모든 인물을 다 사랑하고 싶고, 모든 인물에게 충분한 시간을 주고 싶지만, 30명을 다 빚는 데 한 달이 걸립니다. 한 달 뒤 작품을 시작하려고 폴더를 열었더니, 본편의 전반부에만 등장하는 어떤 단역에 7,000자짜리 통합 시트가 들어 있고, 작품 내내 등장하는 주인공에게는 1,500자짜리 짧은 메모만 들어 있습니다. 분량이 역전된 것입니다.
...
이야기 작법에는 오래된 격언이 있습니다. "모든 인물은 자기 자신의 이야기 속 주인공이다." 화면을 잠깐 스치는 단역조차 자기 삶의 한가운데를 살아간다는 뜻이지만, 이 말이 모두에게 똑같은 분량을 주라는 뜻은 아닙니다. 〈코코〉의 미겔이 주인공으로 깊게 그려지는 동안, 곁을 채우는 수많은 인물은 짧지만 또렷하게 처리됩니다. 깊이의 차등과 인물에 대한 존중은 별개라는 이야기입니다.
...
이 모듈은 시리즈물이나 장편 후속작이 가능한 작품에서 켜고, 단편이라면 거의 켜지 않습니다. 단편의 캐릭터는 그 단편 안에서 시작하고 끝나서, 5년 후의 모습이 작품에 영향을 주지 않습니다.

## 모듈 3. 참조 캐릭터 매핑

이 모듈은 발상이 막히거나 톤이 잡히지 않을 때 켭니다. 이미 존재하는 다른 작품의 캐릭터들을 참조해 자기 캐릭터의 결을 잡는 작업입니다.

작업은 이렇게 진행됩니다. 외국 작품 캐릭터 한두 명, 한국 작품 캐릭터 한두 명을 골라 두고, 자기 캐릭터가 이들의 어느 측면을 차용했는지와 어느 측면을 일부러 비틀었는지를 한 줄씩 적습니다. 마지막으로 그 참조 캐릭터들의 흔한 함정(자주 빠지는 클리셰)을 메모해 두고 그 함정을 피하기로 합니다.
...
이 여덟 항목이 미리 정리되어 있으면 12단계의 작업 완성도가 올라갑니다. 시드를 결정하는 단계, 자기 객관화 단계, 일상단면 시나리오 단계, 관계망 단계 등 모든 단계에서 이 여덟 항목을 참조합니다. 한 인물의 직업이 그 세계관의 사회 구조에 맞는지, 그의 능력이 기술 수준 안에서 가능한지, 그의 갈등이 작품의 톤에 맞는지를 매 단계에서 자동으로 점검합니다.
...
모듈 1·2·3·5의 적용 여부와 모듈 4의 참조 범위는 시드 결정 직후 한 번에 확정합니다. 단, 모듈 4의 세계관 자료 자체는 앞 절에서 설명했듯 12단계 진입 전에 준비되어 있어야 합니다. 결정 양식은 단순합니다.
...
위계와 5개 모듈의 적용표는 시드 결정 직후 확정합니다. 다만 모듈 4의 세계관 자료는 그보다 앞서, 12단계에 들어가기 전에 준비합니다. 시드 한 줄이 정리되면 그 옆에 위계 한 줄과 5개 모듈의 적용표를 함께 두고, 이 셋이 한 묶음으로 후속 11단계를 따라갑니다.

이 결정이 본격 작업의 토대가 됩니다. 같은 시드라도 위계가 달라지면 작업 분량이 달라지고, 같은 위계라도 모듈 적용이 달라지면 산출의 결이 달라집니다. 12 단계의 절차는 같지만, 결정의 조합에 따라 다른 인물이 빚어집니다.
